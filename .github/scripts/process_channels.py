    ...
    while i < len(lines):
        ...
        if line.startswith('#EXTINF'):
            ...
            if 'tvg-logo=""' in line or 'tvg-logo=' not in line:
                line = re.sub('tvg-logo="[^"]*"', 'tvg-logo="https://raw.githubusercontent.com/bscandua/link/refs/heads/main/tv-logo/vavoo.png"', line)
                if 'tvg-logo=' not in line:
                    line = line.replace('group-title=', 'tvg-logo="https://raw.githubusercontent.com/bscandua/link/refs/heads/main/tv-logo/vavoo.png" group-title=')
